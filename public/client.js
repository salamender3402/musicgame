...
const bgmPlaylist = ["/bgm/bgm1.mp3", "/bgm/bgm2.mp3", "/bgm/bgm3.mp3"];
...
function triggerUpgradeModal(tile) {
  ...
  const lvNames = ["공터", "🪵 1단계: 간이 무대", "🎻 2단계: 공작의 음악실", "🏛️ 3단계: 대형 콘서트홀", "🌐 4단계: 월드 스타디움 (랜드마크)"];
